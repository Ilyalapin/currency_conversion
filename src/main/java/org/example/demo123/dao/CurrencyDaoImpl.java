...
import org.example.demo123.exception.DataBaseException;
import org.example.demo123.exception.EntitiesException;
...
public class CurrencyDaoImpl implements CurrencyDao {
    ...
    @Override
    public Currency addCurrency(Currency entity) {
    ...
    public Optional<Currency> updateCurrency(Currency currency) {
        ...
        try(Connection connection = DataBaseUtilsConnection.getConnection();
            ...
            throw new DataBaseException("Failed to update currency with code: " + currency.getCode()+" to the database");
        }
    ...
    public void removeCurrency(Long id) {
        ...
        try(Connection connection = DataBaseUtilsConnection.getConnection();
            ...
            throw new DataBaseException("Failed to remove currency with id: " + id +" from the database");
        }
    }
    ...
    public Optional<Currency> findById(Long id) {
        ...
        try(Connection connection = DataBaseUtilsConnection.getConnection();
            ...
            throw new DataBaseException("Failed to find currency with id: " + id +" to the database");
        }
        return Optional.empty();
    }
